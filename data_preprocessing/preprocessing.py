...
class Preprocessor:
    ...
    def dropUnnecessaryColumns(self,data,columnNameList):
        ...
        self.logger_object.log(self.file_object,
                               'entered drop unecessary column removal ')
        data = data.drop(columnNameList,axis=1)

        self.logger_object.log(self.file_object,
                           'finished dropping of  unecessary columns ')
        return data
    ...
    def encodeCategoricalValues(self,data):
     ...
     self.logger_object.log(self.file_object, 'started encoding categorical values')
    ...
    # back to original
     ...
     self.logger_object.log(self.file_object, 'finished encoding categorical values')
    ...
    def impute_missing_values(self, data):
        ...
        try:
            ...
            self.logger_object.log(self.file_object, 'Imputing missing values Successful. Executed the impute_missing_values method of the Preprocessor class')
