...
class trainModel:
    ...
    def trainingModel(self):
        ...
        try:
            ...
            data_getter = DataLoader.Data_Getter(self.file_object, self.log_writer)
            data = data_getter.get_data()

            """Performing data preprocessing"""
            preprocessor = preprocessing.Preprocessor(self.file_object, self.log_writer)

            data = preprocessor.dropUnnecessaryColumns(data, ['TSH_measured', 'T3_measured', 'TT4_measured', 'T4U_measured',
